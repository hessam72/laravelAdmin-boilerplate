...
@section('content')
    <div class="form-structor">
        <div id="login-section" class="signup {{ str_contains(request()->url(), '/register') ? 'slide-up' : '' }} ">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-holder">
                    ...
                    <input id="email" value="{{ old('email') }}" type="email" name="email" class="input" required
        ...
        <div id="singup-section" class="login {{ str_contains(request()->url(), '/login') ? 'slide-up' : '' }} ">
            <div class="center">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div id="singup-errors">
                        <x-forms.error :message="$errors->get('name')" />
                        <x-forms.error :message="$errors->get('email')" />
                        <x-forms.error :message="$errors->get('password')" />
                        <x-forms.error :message="$errors->get('password_confirmation')" />
                    </div>
                </form>
            </div>
        </div>

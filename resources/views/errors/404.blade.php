    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center text-item">
                    <h1>404</h1>
                    <h2>صفحه مورد نظر شما یافت نشد!</h2>
                    <p>برای برگشتن به صفحه اول وبسایت از دکمه زیر استفاده کنید
                    </p><br/>
                    <a href="/" class="btn green">خانه</a>
                </div>
                <div class="col-md-6 align-self-center svg-item">
